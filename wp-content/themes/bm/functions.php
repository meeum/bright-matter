...
function html5blank_header_scripts() {
    if ( $GLOBALS['pagenow'] != 'wp-login.php' && ! is_admin() ) {
        ...
        //     wp_register_script(
        //         'html5blankscripts',
        //         get_template_directory_uri() . '/resources/prod/scripts.css',
        //         array(
        //             'conditionizr',
        //             'modernizr',
        //             'jquery'
        ...
        // } else {
            // Scripts minify
            wp_register_script( 'html5blankscripts-min', get_template_directory_uri() . '/resources/prod/scripts.js', array(), '1.0.0' );
            // Enqueue Scripts
